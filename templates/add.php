    ...
    <form class="form form--add-lot container <?= $classname; ?>" action="add.php" method="post"
        ...
        <div class="form__item form__item--wide <?= $classname ?>">
            ...
            <textarea id="description" name="description"
                      placeholder="Напишите описание лота"><?= htmlspecialchars(getPostVal('description')); ?></textarea>
        ...
        <div class="form__item form__item--file form__item--invalid">
            ...
            <div class="form__input-file <?= $classname ?>">
                <input class="visually-hidden" type="file" name="lot-img" id="lot-img"
                       value="<?= getFilesVal('lot-img'); ?>">
        ...
        <div class="form__container-three">
            ...
            <div class="form__item form__item--small <?= $classname ?>">
                ...
                <input id="first_price" type="text" name="first_price" placeholder="0"
                       value="<?= htmlspecialchars(getPostVal('first_price')); ?>">
            ...
            <div class="form__item form__item--small <?= $classname ?>">
                ...
                <input id="bet_step" type="text" name="bet_step" placeholder="0"
                       value="<?= htmlspecialchars(getPostVal('bet_step')); ?>">
            ...
            <div class="form__item <?= $classname ?>">
                ...
                <input class="form__input-date" id="date_delection" type="text" name="date_delection"
                       placeholder="Введите дату в формате ГГГГ-ММ-ДД"
                       value="<?= htmlspecialchars(getPostVal('date_delection')); ?>">
